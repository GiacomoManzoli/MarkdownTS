...
describe("ListRule", () => {
    ...
    describe("applyTo", () => {
        // test("I:  ApplyTo", () => {
        //     const input = "*text* _text_\n\n* list 1\n* list 2\n\n<hr />";
        //     const REPLACE_RESULT = "<ul><li><span>list 1</span></li><li><span>list 2</span></li></ul>";
        //     rule.replace = jest.fn().mockReturnValue(REPLACE_RESULT);
        //     rule.clearExtraTag = jest.fn().mockImplementation((a) => `\n${a}\n`);
    
        //     const output = rule.applyTo(input);
    
        //     expect(rule.replace).toHaveBeenCalled();
        //     expect(rule.clearExtraTag).toHaveBeenCalledWith(REPLACE_RESULT, 1);
        ...
        // test("I: clearExtraTag not mocked", () => {
        //     const input = "*text* _text_\n\n* list 1\n* list 2\n\n<hr />";
        //     rule.replace = jest.fn().mockReturnValue("<ul><li><span>list 1</span></li></ul><ul><li><span>list 2</span></li></ul>");
        //     const output = rule.applyTo(input);
        ...
        // test("I: ApplyTo (replace not mocked)", () => {
        //     const input = "*text* _text_\n\n* list 1\n* list 2\n\n<hr />";
        //     rule.afterReplace = jest.fn().mockReturnValue("\n<ul><li><span>list 1</span></li><li><span>list 2</span></li></ul>\n");
    
        //     const output = rule.applyTo(input);
    
        //     expect(rule.afterReplace).toHaveBeenCalled();
